# DAI 2026 MetaRoute Submission Checklist

Checked against the official ACM SIG Proceedings template bundle and the DAI 2026 Industry Track instructions.
...
- If OpenReview asks for a source package, upload `submission/DAI26_MetaRoute_Source.zip`.
